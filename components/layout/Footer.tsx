      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              ...
              <div>
                ...
                <p className="text-xs font-medium text-[#F5F0E8]">POS · Central · South</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 p-3 bg-[#1A1A1A] rounded-lg border border-[#C9A84C]/10">
              ...
              <div className="flex flex-wrap gap-2 text-sm">
                <span className="badge-gray text-xs">💰 Cash on Delivery</span>
                <span className="badge-gray text-xs">💳 Linx</span>
                <span className="badge-gray text-xs">🏦 Online Banking</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[#C9A84C]/10 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-[#9A8F7A]">
            © {new Date().getFullYear()} zip.tt — Made with ❤️ in Trinidad & Tobago
          </p>
