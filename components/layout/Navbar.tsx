...
export function Navbar() {
  ...
  const categories = [
    ...
    { name: 'Streetwear', href: '/products?category=urban-fashion', icon: '🧢' },
    { name: 'Carnival & Mas', href: '/products?category=carnival', icon: '🎭' },
    { name: 'Toys & Kids', href: '/products?category=toys', icon: '🧸' },
    { name: 'Rum & Spirits', href: '/products?category=rum-spirits', icon: '🥃' },
    { name: 'Home & Garden', href: '/products?category=home-garden', icon: '🏠' },
  ]
