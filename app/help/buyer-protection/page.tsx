        ...
        <section style={{ marginBottom: '40px' }}>
          <div style={{ background: '#1A1000', border: '1px solid #5a4000', borderRadius: '12px', padding: '32px' }}>
            ...
            <p style={{ color: '#9A8F7A', fontSize: '14px', lineHeight: '1.6', marginBottom: '12px' }}>
              Digital products (Netflix, Spotify, game codes, software licenses, etc.) are <strong style={{ color: '#F5F0E8' }}>non-refundable once the code has been revealed</strong>. This policy exists because digital codes cannot be "returned" — once seen, they may have been used.
            </p>
        ...
        <section style={{ marginBottom: '40px' }}>
          <div style={{ background: '#111111', border: '1px solid #C9A84C', borderRadius: '12px', padding: '32px' }}>
            ...
            <p style={{ color: '#9A8F7A', fontSize: '14px', lineHeight: '1.6', marginBottom: '16px' }}>
              <strong style={{ color: '#F5F0E8' }}>IMPORTANT:</strong> Contact zip.tt support FIRST before contacting your bank or card provider. We can resolve most issues within 1–2 business days.
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {[
