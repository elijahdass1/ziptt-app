  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div className="bg-[var(--bg-secondary)] border border-[#C9A84C]/15 rounded-2xl p-5 space-y-4 text-sm">
        ...
        <div>
          <p className="text-[var(--text-primary)] font-medium">My order is still Pending after several hours — is that normal?</p>
        ...
        <div>
          <p className="text-[var(--text-primary)] font-medium">My estimated delivery time has passed — what should I do?</p>
