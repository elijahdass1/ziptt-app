    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
      ...
      <div>
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="text-3xl font-black text-[var(--text-primary)]">Returns & Refunds</h1>
        </div>
      ...
      <div className="bg-[#C9A84C]/10 border border-[#C9A84C]/30 rounded-2xl p-5 flex items-center gap-4">
        ...
        <div>
          <p className="font-semibold text-[var(--text-primary)]">7-Day Return Window</p>
          <p className="text-sm text-[var(--text-secondary)] mt-0.5">You have 7 days from the delivery date to request a return.</p>
        </div>
      </div>

      {/* Eligible / not eligible */}
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="bg-[var(--bg-secondary)] border border-green-500/20 rounded-2xl p-5">
      ...
      <div className="text-center pt-2">
        <p className="text-[var(--text-secondary)] text-sm">Still have questions? <Link href="/help/contact" className="text-[#C9A84C] hover:underline font-medium">Contact our support team</Link></p>
      </div>
    </div>
  )
}
