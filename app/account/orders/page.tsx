    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        <div className="flex items-center gap-2 mb-6">
          <Package className="h-6 w-6 text-[#C9A84C]" />
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {(order.status === 'CONFIRMED' || order.status === 'DELIVERED') && (
                        <Link
                          ...
                          className="inline-flex items-center gap-1 text-xs text-amber-600 hover:text-amber-700 font-medium border border-amber-300 rounded px-2 py-1 hover:bg-amber-50 transition-colors min-h-11"
                        >
