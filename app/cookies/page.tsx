...
export default function CookiesPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8">
      <div>
        <h1 className="text-3xl font-black text-[var(--text-primary)] mb-2">Cookie Policy</h1>
        <p className="text-sm text-[var(--text-secondary)]">Last updated: January 2025</p>
      </div>

      <div className="space-y-2">
        <h2 className="text-lg font-bold text-[var(--text-primary)]">What Are Cookies?</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-[var(--text-primary)] mb-4">Cookies We Use</h2>
        <div className="space-y-4">
          {cookieTypes.map((c) => (
            <div key={c.type} className="bg-[var(--bg-secondary)] border border-[#C9A84C]/15 rounded-2xl p-5">
              <div className="flex items-center justify-between mb-2">
                <p className="font-bold text-[var(--text-primary)]">{c.type}</p>
                <span className={`text-xs px-2.5 py-1 rounded-full font-medium ${c.required ? 'bg-[#C9A84C]/20 text-[#C9A84C] border border-[#C9A84C]/30' : 'bg-[var(--bg-card)] text-[var(--text-secondary)] border border-white/10'}`}>
              ...
              <div className="flex flex-wrap gap-2">
                {c.examples.map((ex) => (
                  <span key={ex} className="text-xs bg-[var(--bg-primary)] border border-[#C9A84C]/10 text-[var(--text-secondary)] px-2.5 py-1 rounded-full">{ex}</span>
                ))}
              </div>
            </div>
          ))}
      ...
      <div className="space-y-2">
        <h2 className="text-lg font-bold text-[var(--text-primary)]">Third-Party Cookies</h2>
        <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
      ...
      <div className="space-y-2">
        <h2 className="text-lg font-bold text-[var(--text-primary)]">Managing Cookies</h2>
        <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
